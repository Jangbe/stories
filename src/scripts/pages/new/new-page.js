...
export default class NewPage {
            ...
            <div class="form-control">
              ...
              <div class="new-form__description__container">
                <textarea
                  ...
                  name="description"
                  placeholder="Masukkan keterangan lengkap cerita. Ceritakan kejadian menarik yang ingin ada sampaikan."
                ></textarea>
              </div>
            </div>
            <div class="form-control">
              <label for="photo-input" class="new-form__photo">Dokumentasi</label>
              <div id="photo-more-info">Anda dapat menyertakan foto sebagai dokumentasi.</div>
  ...
  #setupForm() {
    ...
    document.getElementById('photo-input').addEventListener('change', async (event) => {
      await this.#changeTakenPicture(event.target.files[0]);
  ...
  #setupCamera() {
    ...
    this.#camera.addCheeseButtonListener('#camera-take-button', async () => {
      ...
      console.log(image);
      await this.#changeTakenPicture(image);
      await this.#populateTakenPicture();
    });
  }

  async #changeTakenPicture(image) {
    let blob = image;
  ...
  async #populateTakenPicture() {
    ...
    const html = `
      <li class="new-form__photo__outputs-item">
        <button type="button" class="new-form__photo__outputs-item__delete-btn">
          <img src="${imageUrl}" alt="Dokumentasi Cerita">
        </button>
      </li>
    `;
